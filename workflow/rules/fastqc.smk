...
rule fastqc:
    ...
    output:
        zip_file_1              = OUTPUT_DIR + "qc/fastqc/{sample}_R1_fastqc.zip",
        zip_file_2              = OUTPUT_DIR + "qc/fastqc/{sample}_R2_fastqc.zip",  
        trimmed_zip_file_1      = OUTPUT_DIR + "qc/fastqc/{sample}_trimmed_R1_fastqc.zip",
        trimmed_zip_file_2      = OUTPUT_DIR + "qc/fastqc/{sample}_trimmed_R2_fastqc.zip"        
    params:
        output_dir              = OUTPUT_DIR + "qc/fastqc/"     
    message:
